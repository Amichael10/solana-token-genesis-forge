...
const AppSidebar = ({
  ...
  return <Sidebar variant="inset">
      ...
      {/* Adjusted padding-top to align with the main content header */}
      <SidebarContent className="pt-14">
        {isPreviewRoute ? <SidebarGroup>
            <SidebarGroupLabel className="px-4 py-2">Launch Preview</SidebarGroupLabel>
            <SidebarMenu className="mt-3 space-y-3">
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={true} tooltip="Review Launch" className="px-4 py-3">
            ...
            <SidebarMenu className="mt-3 space-y-3">
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="Token Basics - Configure name, symbol, and supply" isActive={isIndexRoute && currentStep === 1} onClick={() => setCurrentStep(1)} className="px-4 py-4 h-auto min-h-[4rem]">
              ...
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="Bonding Curve - Set token pricing model" isActive={isIndexRoute && currentStep === 2} onClick={() => setCurrentStep(2)} className="px-4 py-4 h-auto min-h-[4rem]">
              ...
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="Allocation - Distribute token supply" isActive={isIndexRoute && currentStep === 3} onClick={() => setCurrentStep(3)} className="px-4 py-4 h-auto min-h-[4rem]">
              ...
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="Vesting Schedule - Lock tokens over time" isActive={isIndexRoute && currentStep === 4} onClick={() => setCurrentStep(4)} className="px-4 py-4 h-auto min-h-[4rem]">
              ...
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="Liquidity - Configure swap pools" isActive={isIndexRoute && currentStep === 5} onClick={() => setCurrentStep(5)} className="px-4 py-4 h-auto min-h-[4rem]">
              ...
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="Launchpad - Set fundraising parameters" isActive={isIndexRoute && currentStep === 6} onClick={() => setCurrentStep(6)} className="px-4 py-4 h-auto min-h-[4rem]">
        ...
        <SidebarGroup className="mt-8">
          ...
          <SidebarMenu className="mt-3 space-y-3">
            <SidebarMenuItem>
              <SidebarMenuButton onClick={showComingSoon} tooltip="Manage your tokens" className="px-4 py-4 h-auto min-h-[4rem]">
            ...
            <SidebarMenuItem>
              <SidebarMenuButton onClick={showComingSoon} tooltip="Adjust app settings" className="px-4 py-4 h-auto min-h-[4rem]">
